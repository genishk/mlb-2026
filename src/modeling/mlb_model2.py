...
class MLBBettingModel2:
    ...
    def _plot_feature_importance(self, importances):
        ...
        plt.savefig(img_dir / f"feature_importance_model2_{timestamp}.png")
        plt.close()
    ...
    def save_model(self, timestamp: str = None) -> str:
        ...
        # 모델 파일 경로
        model_path = self.model_dir / f"mlb_betting_model2_{timestamp}.joblib"
        feature_path = self.model_dir / f"mlb_features2_{timestamp}.json"
...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            ...
            with open(pred_dir / f"mlb_game_predictions_model2_{timestamp}.json", 'w') as f:
                json.dump(predictions, f, indent=2)
            
            print(f"예측 결과 저장 완료: {pred_dir / f'mlb_game_predictions_model2_{timestamp}.json'}")
