"""
MLB 총점(Over/Under) 예측 모델 2 - CatBoost Regressor
기존 mlb_model2.py 기반, 타겟만 total_score로 변경
"""
import pandas as pd
import numpy as np
...
class MLBTotalsModel2:
    """CatBoost 회귀 모델 - MLB 총점 예측"""
    ...
    def train_model(self, X: pd.DataFrame, y: pd.Series) -> Dict:
        ...
        print("\n=== 총점 예측 모델 학습 시작 (CatBoost Regressor) ===")
    ...
    def save_model(self, timestamp: str = None) -> str:
        ...
        model_path = self.model_dir / f"mlb_totals_model2_{timestamp}.joblib"
        feature_path = self.model_dir / f"mlb_totals_features2_{timestamp}.json"
