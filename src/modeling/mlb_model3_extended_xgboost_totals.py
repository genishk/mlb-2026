"""
MLB 총점(Over/Under) 예측 — Model3 확장 (XGBoost Regressor)
...
class MLBTotalsModel3ExtendedXGBoost:
    """XGBoost 회귀 — 확장 특성 기반 MLB 총점 예측"""
    ...
    def train_model(self, X: pd.DataFrame, y: pd.Series) -> Dict:
        ...
        print("\n=== 총점 예측 모델 학습 시작 (Model3 확장 XGBoost Regressor) ===")
    ...
    def save_model(self, timestamp: str = None) -> str:
        ...
        model_path = self.model_dir / f"mlb_totals_model3_extended_xgboost_{timestamp}.joblib"
        feature_path = self.model_dir / f"mlb_totals_features3_extended_xgboost_{timestamp}.json"
            ...
            json.dump(
                {
                    ...
                    'model_info': {
                        'type': 'xgboost_regressor_extended',
                        'target': 'total_score',
...
if __name__ == "__main__":
    ...
    model = MLBTotalsModel3ExtendedXGBoost()
